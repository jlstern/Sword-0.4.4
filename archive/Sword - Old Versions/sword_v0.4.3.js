...
function levelUp(currentPath){
	// unhide div menu
	for(i = 0; i < popUp.length; i++){
		popUp[i].classList.remove("hidden");
	}
	// drop in three small divs with path icons
	// on hover, each displays more information
	// add click event listener; window and divs disappear on click; complete levelUp
	// change hero stats
	var newPath = 1;
	...
	// unhide relevant new skill; if passive activate pass effect
}
